...
namespace Pierre.Darcas.FeatureMatching.WebApi.Controllers;
[ApiController]
[Route("[controller]")] 
...
public class FeatureMatchingController : ControllerBase
{
    ...
    public async Task<IActionResult> OnPostUploadAsync(List<IFormFile> files)
    {
        ...
        IList<byte[]> listImageSceneData = new List<byte[]>();
        listImageSceneData.Add(imageSceneData);
        
        var detectObjectInScenes= await _objectDetection.DetectObjectInScenes(imageObjectData, listImageSceneData);
        
        
        // Your implementation code
        return File(detectObjectInScenes.First().ImageData,"image/jpg");
